#!/usr/bin/env python3
"""
Final fix using HTML formatting for proper line breaks in Azure DevOps
"""
...
def main():
    ...
    print(f"🔧 Applying HTML formatting fix for proper display...")
    ...
    # Test with just ORD-005 first
    story_id = 'ORD-005'
    work_item_id = story_mapping.get(story_id)
    
    if work_item_id:
        print(f"🔧 Testing HTML fix on {story_id}...")
        ...
        try:
            ...
            print(f"\n✅ Updated {story_id} with HTML formatting")
            print(f"🔗 Check result: {ORGANIZATION_URL}/{PROJECT_NAME}/_workitems/edit/{work_item_id}")
